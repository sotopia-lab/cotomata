...
from .generate import agenerate_fc # type: ignore[import-untyped]
                ...
                if self.count_ticks % self.query_interval == 0:
                    try:
                        ...
                        tools = [{
                            ...
                            "function": {
                                "name": "speak",
                                "description": "you can talk to the other agents to share information or ask them something",
                                "parameters": {
                                    "type": "object",
                                    "properties": {
                                        "content": {
                                            "type": "string",
                                            "description": "the message to send to the other agents (should be short)"
                                        }
                                    },
                                    "required": [
                                        "content"
                        ...
                        agent_action = await agenerate_fc(
